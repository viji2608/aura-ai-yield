  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white hover:shadow-glow hover:scale-105 transition-spring font-semibold",
        glass: "glass hover:bg-card/50 border-primary/20 hover:border-primary/40 text-foreground",
        glow: "bg-primary text-primary-foreground shadow-glow animate-glow-pulse hover:animate-none hover:shadow-primary",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-accent",
